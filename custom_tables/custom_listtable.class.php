...
if(!class_exists('Custom_tplus_List_Table')){
	class Custom_tplus_List_Table extends WP_List_Table
	{
		/**
		...
		function get_columns()
		{
			$columns = array(
				...
				'pippo' => __('pippo', 'custom_table_example'),
			);
			return $columns;
		}
		...
		{
			global $wpdb;
			$table_name = $wpdb->prefix . 'tplus_'; // do not forget about tables prefix
